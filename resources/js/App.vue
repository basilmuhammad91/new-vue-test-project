            ...
            <div class="row">
              <div class="col-xl-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <svg
                      class="svg-inline--fa fa-chart-area fa-w-16 me-1"
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fas"
                  ...
                  <div class="card-body">
                    ...
                    <canvas
                      ...
                      width="492"
                      height="196"
                      style="display: block; width: 492px; height: 196px"
              ...
              <div class="col-xl-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <svg
                      class="svg-inline--fa fa-chart-bar fa-w-16 me-1"
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fas"
                      data-icon="chart-bar"
                ...
                >
                  ...
                  <div class="dataTable-container">
                    <table id="datatablesSimple" class="dataTable-table">
                      <thead>
                        <tr>
                          <th data-sortable="" style="width: 19.5777%">
                            <a href="#" class="dataTable-sorter">Name</a>
                          </th>
                          <th data-sortable="" style="width: 28.9827%">
                            <a href="#" class="dataTable-sorter">Position</a>
                          </th>
                          <th data-sortable="" style="width: 15.643%">
                            <a href="#" class="dataTable-sorter">Office</a>
                          </th>
                          <th data-sortable="" style="width: 9.11708%">
                            <a href="#" class="dataTable-sorter">Age</a>
                          </th>
                          <th data-sortable="" style="width: 15.1631%">
                            <a href="#" class="dataTable-sorter">Start date</a>
                          </th>
                          <th data-sortable="" style="width: 11.5163%">
